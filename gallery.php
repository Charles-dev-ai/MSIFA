        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                    ...
                    <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Galleries
                    </h1>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-3">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                            <li class="ftco-animate"><a href="gallery.html#"><span class="icon-twitter"></span></a></li>
                            <li class="ftco-animate"><a href="gallery.html#"><span class="icon-facebook"></span></a>
                            </li>
                            <li class="ftco-animate"><a href="gallery.html#"><span class="icon-instagram"></span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            ...
                            <div class="text">
                                <h3 class="heading"><a href="gallery.html#">Even the all-powerful Pointing has no
                                        control about</a></h3>
                                <div class="meta">
                                    <div><a href="gallery.html#"><span class="icon-calendar"></span> July 12, 2018</a>
                                    </div>
                                    <div><a href="gallery.html#"><span class="icon-person"></span> Admin</a></div>
                                    <div><a href="gallery.html#"><span class="icon-chat"></span> 19</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="block-21 mb-4 d-flex">
                ...
                <div class="col-md-2">
                    <div class="ftco-footer-widget mb-4 ml-md-4">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="gallery.html#" class="py-2 d-block">Home</a></li>
                            <li><a href="gallery.html#" class="py-2 d-block">About</a></li>
                            <li><a href="gallery.html#" class="py-2 d-block">Donate</a></li>
                            <li><a href="gallery.html#" class="py-2 d-block">Causes</a></li>
                            <li><a href="gallery.html#" class="py-2 d-block">Event</a></li>
                            <li><a href="gallery.html#" class="py-2 d-block">Blog</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                ...
                                <li><a href="gallery.html#"><span class="icon icon-phone"></span><span class="text">+2
                                            392 3929 210</span></a></li>
                                <li><a href="gallery.html#"><span class="icon icon-envelope"></span><span class="text">info@yourdomain.com</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
